...
public class DefaultValues {
    public static List<Product> getDefaultProducts() {
        ...
        defaultProducts.add(new Product("Standard", 100.00f, "Admin"));
        defaultProducts.add(new Product("Premium", 250.99f, "Admin"));
        defaultProducts.add(new Product("Ultra", 345.45f, "Admin"));
