...
public class AdminControllerEnvironment {
	...
	public static String SHOWMETAINFO_PAGE = "admin/showmetainfo";
	...
	public static String ATTR_ADMINUSERNAME = "adminusername";
	public static String ATTR_ERRORADMINACCOUNT = "erroradminaccount";
	public static String ATTR_ALLATTRIBUTES = "allatributes";
	public static String ATTR_ALLOBJECTTYPES = "allobjecttypes";
	...
	public static String MSG_NULLATTEMPTS = "You have exceeded the number of attempts to "
			+ "enter the user name and password.";
	public static String MSG_WRONGOLDPASS = "Wrong old password!";
	public static String MSG_WRONGREPATPASS = "Not equals value of fields new password and "
			+ "repeat password!";
	
	public static String REDIRECT_LOGIN = "redirect:login.html";
	public static String REDIRECT_SHOWMENUITEMS = "redirect:showmenuitems.html";
}
